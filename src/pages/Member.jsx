...
const Member = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Member upgrade data:", formData, "Type:", accountType);
    // TODO: Implement member upgrade logic with Supabase
    const message = accountType === "member"
      ? "Congratulations! You are now a member!"
      : "Congratulations! Your organization has been registered!";
    alert(message);
    navigate("/");
  };
    ...
    <div>
      ...
      <div className="member-container">
        <div className="member-card">
          ...
          <p className="member-subtitle">Upgrade Your Account</p>
          <p className="member-description">
            Choose your account type and complete the form to access exclusive benefits and services.
          </p>
